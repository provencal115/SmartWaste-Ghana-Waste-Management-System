        ...
        <div class="row g-4 mb-5">
            <div class="col-lg-4">
                <h5 class="mb-3 d-flex align-items-center gap-2">
                    <img src="<?= e(siteLogo()) ?>" alt="SmartWaste" class="footer-brand-logo" width="32" height="32" loading="lazy">
                    SmartWaste Ghana
                </h5>
                <p class="small footer-text-muted">The modern waste collection and inventory platform built for municipalities and private waste companies across Ghana.</p>
            ...
            <div class="col-lg-4">
                ...
                <p class="small mb-2 footer-text-muted"><i class="fa-solid fa-envelope me-2 footer-icon-accent"></i><?= e(companyInfo()['email']) ?></p>
                <p class="small mb-2 footer-text-muted"><i class="fa-solid fa-phone me-2 footer-icon-accent"></i><?= e(companyInfo()['phone']) ?></p>
                <p class="small footer-text-muted"><i class="fa-solid fa-location-dot me-2 footer-icon-accent"></i><?= e(companyInfo()['address']) ?></p>
            </div>
        </div>
        <hr style="border-color:rgba(255,255,255,0.08);margin:0 0 1.5rem">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
            <p class="small mb-0 footer-text-subtle">&copy; <?= date('Y') ?> SmartWaste Ghana. All rights reserved.</p>
            <div class="d-flex gap-3 small footer-text-subtle">
